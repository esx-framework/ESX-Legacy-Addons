...
Config.DistanceMultiplier         = 0.15 -- Earnings per meter traveled
Config.TimeMultiplier             = 2.0  -- Earnings per second (for waiting time)

-- Tip System
Config.EnableTips                 = true
Config.TipChance                  = 60   -- % chance customer gives a tip
Config.TipAmount                  = {min = 50, max = 200}
Config.PerfectDriveTipBonus       = 1.5  -- Multiplier for perfect driving (no crashes, smooth)

-- Reputation System
Config.EnableReputation           = true
Config.MaxReputation              = 100
Config.ReputationGainPerJob       = 2
Config.ReputationLossPerBadJob    = 5
Config.ReputationBonusThreshold   = 75   -- Above this, get bonus earnings
Config.ReputationBonus            = 1.25 -- 25% bonus

-- Rush Hour System
Config.EnableRushHour             = true
Config.RushHours                  = {
    {start = 7, finish = 9},   -- Morning rush
    {start = 17, finish = 19}  -- Evening rush
}
Config.RushHourMultiplier         = 1.5

-- Weather Bonus
Config.EnableWeatherBonus         = true
Config.BadWeatherMultiplier       = 1.3  -- Rain/Thunder bonus

-- Special Missions
Config.EnableSpecialMissions      = true
Config.SpecialMissionChance       = 15   -- % chance
Config.AirportRuns                = {enabled = true, bonus = 500}
Config.VIPClients                 = {enabled = true, bonus = 750}
Config.LongDistance               = {enabled = true, minDistance = 5000, bonus = 400}
...
Config.AuthorizedVehicles = {
	{model = 'taxi', title ='Economy Taxi', icon = 'fas fa-car', type = 'economy', multiplier = 1.0},
	{model = 'taxi2', title ='Standard Taxi', icon = 'fas fa-car', type = 'standard', multiplier = 1.2},
	{model = 'stretch', title ='Luxury Limo', icon = 'fas fa-car-side', type = 'luxury', multiplier = 1.8, minGrade = 2}
}
