Locales['sr'] = {
  ...
  ['recovery_gazbottle']        = 'Povraćaj gasa...',
  ['recovery_fixtool']          = 'Repair Tools povraćaj...',
  ['recovery_carotool']         = 'Body Tools povraćaj...',
  ['not_enough_gazbottle']      = 'Nemate dovoljno gas cans.',
  ['assembling_blowpipe']       = 'Sastavljanje Blowtorch...',
  ['not_enough_fixtool']        = 'Nemate dovoljno repair tools.',
  ['assembling_fixkit']         = 'Sastavljanje Repair Kit...',
  ['not_enough_carotool']       = 'Nemate dovoljno body tools.',
  ['assembling_carokit']        = 'Sastavljanje Body Kit...',
