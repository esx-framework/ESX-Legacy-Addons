Locales['pl'] = {
  ...
  ['recovery_gazbottle']        = 'odzyskiwanie Kanistra z paliwem...',
  ['recovery_fixtool']          = 'odzyskiwanie Części naprawczych...',
  ['recovery_carotool']         = 'odzyskiwanie Części blacharskich...',
  ['not_enough_gazbottle']      = 'nie posiadasz ~r~wystarczająco paliwa w kanistrze.',
  ['assembling_blowpipe']       = 'składanie Palnika...',
  ['not_enough_fixtool']        = 'nie posiadasz ~r~wystarczająco częsci naprawczych.',
  ['assembling_fixkit']         = 'składanie częsci naprawczych...',
  ['not_enough_carotool']       = 'nie posiadasz ~r~wystarczająco częsci blacharskich.',
  ['assembling_carokit']        = 'składanie częsci blacharskich...',
