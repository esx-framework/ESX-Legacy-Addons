Locales['fi'] = {
  ...
  ['recovery_gazbottle']        = 'Kaasupullon kerääminen menossa...',
  ['recovery_fixtool']          = 'Korjaustyökalujen kerääminen menossa...',
  ['recovery_carotool']         = 'Korin työkalujen kerääminen menossa...',
  ['not_enough_gazbottle']      = 'sinulla ~r~ei ole tarpeeksi kaasupulloja.',
  ['assembling_blowpipe']       = 'kasataan Polttoleikkuria...',
  ['not_enough_fixtool']        = 'sinulla ~r~ei ole tarpeeksi korjaus työkaluja.',
  ['assembling_fixkit']         = 'kasataan Korjauskittiä...',
  ['not_enough_carotool']       = 'sinulla ~r~ei ole tarpeeksi kori työkaluja.',
  ['assembling_carokit']        = 'kasataan Korikittiä...',
