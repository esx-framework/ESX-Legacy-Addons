Locales['nl'] = {
  ...
  ['recovery_gazbottle']        = 'Jerrycan Ophalen...',
  ['recovery_fixtool']          = 'Reparatie gereedschap Ophalen...',
  ['recovery_carotool']         = 'Plaatwerk gereedschap Ophalen...',
  ['not_enough_gazbottle']      = 'je hebt ~r~niet genoeg jerrycans.',
  ['assembling_blowpipe']       = 'In elkaar aan het zetten gasbrander...',
  ['not_enough_fixtool']        = 'je hebt ~r~niet genoeg reparatie gereedschap.',
  ['assembling_fixkit']         = 'In elkaar aan het zetten reparatie set...',
  ['not_enough_carotool']       = 'je hebt ~r~niet genoeg plaatwerk gereedschap.',
  ['assembling_carokit']        = 'In elkaar aan het zetten plaatwerk set...',
