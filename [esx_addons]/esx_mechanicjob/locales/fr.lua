Locales['fr'] = {
  ...
  ['recovery_gazbottle']        = 'Récupération de bouteille de gaz...',
  ['recovery_fixtool']          = 'Récupération d\'outils réparation...',
  ['recovery_carotool']         = 'Récupération d\'outils carosserie...',
  ['not_enough_gazbottle']      = 'Vous n\'avez ~r~pas assez de bouteille de gaz',
  ['assembling_blowpipe']       = 'Assemblage de chalumeaux...',
  ['not_enough_fixtool']        = 'Vous n\'avez ~r~pas assez d\'outils réparation',
  ['assembling_fixkit']         = 'Assemblage de kit réparation...',
  ['not_enough_carotool']       = 'Vous n\'avez ~r~pas assez d\'outils carosserie',
  ['assembling_carokit']        = 'Assemblage de kit carosserie...',
