Locales['fr'] = {
    ...
    ['error_deposit_money']   = "Une erreur s'est produite lors du dépôt, réessayez plus tard !",
    ['error_withdraw_money']  = "Une erreur s'est produite lors du retrait, réessayez plus tard !",
    ['error_transfer_money']  = "Une erreur s'est produite lors du transfert, réessayez plus tard !",
