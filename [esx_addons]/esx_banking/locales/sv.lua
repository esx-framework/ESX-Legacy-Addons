Locales['sv'] = {
    ...
    ['error_deposit_money']       = "Det uppstod ett fel med insättningen, försök igen senare!",
    ['error_withdraw_money']       = "Det uppstod ett fel med uttaget, försök igen senare!",
    ['error_transfer_money']       = "Det uppstod ett fel med överföringen, försök igen senare!",
