Locales['sl'] = {
  ...
  ['error_deposit_money']       = "Prišlo je do napake pri pologu, poskusite kasneje!",
  ['error_withdraw_money']       = "Prišlo je do napake pri dvigu, poskusite kasneje!",
  ['error_transfer_money']       = "Prišlo je do napake pri nakazilu, poskusite kasneje!",
