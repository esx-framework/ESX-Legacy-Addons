Locales['en'] = {
  ...
  ['error_deposit_money']       = "There was an error with the deposit, try again later!",
  ['error_withdraw_money']       = "There was an error with the withdrawal, try again later!",
  ['error_transfer_money']       = "There was an error with the transfer, try again later!",
