		...
		<PageWrapper>
			...
			<div className={'mt-[50px] w-full flex justify-center space-x-[20px]'}>
				...
				<div className={'flex flex-col w-[225px]'}>
					<div className={'select-none relative overflow-y-auto w-full h-[418px] backdrop-blur-[5px] rounded-[10px] pr-[5px]'}>
						...
						<div className={'flex flex-col mt-[20px] space-y-[0px]'}>
							{config.progressdata && config.progressdata.lessons && config.progressdata.lessons.map((lesson, i) => (
								<div key={i} className={'flex'}>
									<div className={'flex flex-col items-center mr-[20px]'}>
										<div className="h-[50px] flex items-center justify-center">
											<div className={`size-[30px] rounded-[5px] flex justify-center items-center ${lesson.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgba(37,37,37,0.25)] border border-[rgba(56,56,56,0.5)]'}`} style={lesson.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}}>
										...
										{i < config.progressdata.lessons.length - 1 && (
											<div className="flex flex-col items-center my-[2px]">
												<div className="flex flex-col items-center space-y-[3px]">
													<div className={`w-[28px] h-[3px] rounded-[1px] ${lesson.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={lesson.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[22px] h-[3px] rounded-[1px] ${lesson.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={lesson.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[16px] h-[3px] rounded-[1px] ${lesson.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={lesson.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[14px] h-[3px] rounded-[1px] ${lesson.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={lesson.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
												</div>
												<div className="h-[2px]"></div>
												<div className="flex flex-col items-center space-y-[3px]">
													<div className={`w-[16px] h-[3px] rounded-[1px] ${config.progressdata.lessons[i + 1].completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={config.progressdata.lessons[i + 1].completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[22px] h-[3px] rounded-[1px] ${config.progressdata.lessons[i + 1].completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={config.progressdata.lessons[i + 1].completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[28px] h-[3px] rounded-[1px] ${config.progressdata.lessons[i + 1].completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={config.progressdata.lessons[i + 1].completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
												</div>
											</div>
										)}
									</div>
									<div className={`w-[145px] h-[50px] rounded-[10px] border flex items-center justify-center ${lesson.completed ? 'bg-[rgba(251,155,4,0.25)] border-[rgba(251,155,4,0.5)]' : 'bg-[rgba(37,37,37,0.25)] border-[rgba(56,56,56,0.5)]'}`}>
										<p className={`uppercase font-semibold text-[15px] ${lesson.completed ? 'text-[rgb(22,22,22)]' : 'text-[rgb(242,242,242)]'}`}>{lesson.label}</p>
									</div>
								</div>
							))}
						</div>
						...
						<div className={'mt-[29px] w-full bg-[rgba(37,37,37,0.25)] h-[50px] border border-[rgba(56,56,56,0.5)] backdrop-blur-[5px] rounded-[10px] flex items-center justify-center relative'}>
							<svg className={'absolute left-[20px]'} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div className={'flex flex-col mt-[20px] space-y-[0px]'}>
							{config.progressdata && config.progressdata.tests && config.progressdata.tests.map((test, i) => (
								<div key={i} className={'flex'}>
									<div className={'flex flex-col items-center mr-[20px]'}>
										<div className={`size-[30px] rounded-[5px] flex justify-center items-center ${test.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgba(37,37,37,0.25)] border border-[rgba(56,56,56,0.5)]'}`} style={test.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}}>
											<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
												{test.completed ? (
													<path d="M7.95832 12.625L15.0208 5.5625C15.1875 5.39583 15.3819 5.3125 15.6042 5.3125C15.8264 5.3125 16.0208 5.39583 16.1875 5.5625C16.3542 5.72917 16.4375 5.92722 16.4375 6.15667C16.4375 6.38611 16.3542 6.58389 16.1875 6.75L8.54165 14.4167C8.37499 14.5833 8.18054 14.6667 7.95832 14.6667C7.7361 14.6667 7.54165 14.5833 7.37499 14.4167L3.79165 10.8333C3.62499 10.6667 3.54499 10.4689 3.55165 10.24C3.55832 10.0111 3.64527 9.81306 3.81249 9.64583C3.97971 9.47861 4.17777 9.39528 4.40665 9.39583C4.63554 9.39639 4.83332 9.47972 4.99999 9.64583L7.95832 12.625Z" fill="#252525" />
												) : (
										...
										{i < config.progressdata.tests.length - 1 && (
											<div className="flex flex-col items-center my-[2px]">
												<div className="flex flex-col items-center space-y-[3px]">
													<div className={`w-[28px] h-[3px] rounded-[1px] ${test.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={test.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[22px] h-[3px] rounded-[1px] ${test.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={test.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[16px] h-[3px] rounded-[1px] ${test.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={test.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[14px] h-[3px] rounded-[1px] ${test.completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={test.completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
												</div>
												<div className="h-[2px]"></div>
												<div className="flex flex-col items-center space-y-[3px]">
													<div className={`w-[16px] h-[3px] rounded-[1px] ${config.progressdata.tests[i + 1].completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={config.progressdata.tests[i + 1].completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[22px] h-[3px] rounded-[1px] ${config.progressdata.tests[i + 1].completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={config.progressdata.tests[i + 1].completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
													<div className={`w-[28px] h-[3px] rounded-[1px] ${config.progressdata.tests[i + 1].completed ? 'bg-[rgb(251,155,4)]' : 'bg-[rgb(37,37,37)] border border-[rgba(56,56,56,0.5)]'}`} style={config.progressdata.tests[i + 1].completed ? { boxShadow: '0px 0px 15px 1px rgba(251, 155, 4, 0.25)' } : {}} />
												</div>
											</div>
										)}
									</div>
									<div className={`w-[145px] h-[50px] rounded-[10px] border flex items-center justify-center ${test.completed ? 'bg-[rgba(251,155,4,0.25)] border-[rgba(251,155,4,0.5)]' : 'bg-[rgba(37,37,37,0.25)] border-[rgba(56,56,56,0.5)]'}`}>
										<p className={`uppercase font-semibold text-[15px] ${test.completed ? 'text-[rgb(22,22,22)]' : 'text-[rgb(242,242,242)]'}`}>{test.label}</p>
									</div>
								</div>
							))}
						</div>
