Locales["fr"] = {
  -- Global menus
  ["cloakroom"] = "vestiaire",
  ["cloak_change"] = "appuyez sur ~b~[E]~s~ pour vous changer.",
  ...
  ["spawn_veh_button"] = "appuyez sur ~b~[E]~s~ pour faire apparaître le véhicule de livraison.",
  ["spawn_truck_button"] = "appuyez sur ~b~[E]~s~ pour faire apparaître le camion.",
  ["spawn_blocked"] = "le point d'apparition du véhicule est encombré",
  ["service_vh"] = "véhicule de fonction",
  ["return_vh"] = "rendre le véhicule",
  ["return_vh_button"] = "appuyez sur ~b~[E]~s~ pour rendre le véhicule.",
  ["delivery_point"] = "point de livraison",
  ["delivery"] = "livraison",
  ["public_enter"] = "appuyez sur ~b~[E]~s~ pour entrer dans l'immeuble.",
  ["public_leave"] = "appuyez sur ~b~[E]~s~ pour retourner à l'entrée de l'immeuble.",

  -- Lumber Jack job
  ["lj_locker_room"] = "vestiaire du bûcheron",
  ["lj_mapblip"] = "tas de bois",
  ["lj_wood"] = "bois",
  ["lj_pickup"] = "appuyez sur ~b~[E]~s~ pour récupérer du bois.",
  ["lj_woodcutting"] = "découpe du bois",
  ["lj_cutwood_button"] = "appuyez sur ~b~[E]~s~ pour couper du bois.",
  ["lj_board"] = "planches",
  ["lj_planks"] = "paquet de planche",
  ["lj_cutwood"] = "bois coupé",
  ["lj_pick_boards"] = "appuyez sur ~b~[E]~s~ pour récupérer des planches.",
  ["lj_deliver_button"] = "appuyez sur ~b~[E]~s~ pour livrer les planches.",

  -- Fisherman
  ["fm_fish_locker"] = "vestiaire du pêcheur",
  ["fm_fish"] = "poisson",
  ["fm_fish_area"] = "zone de pêche",
  ["fm_fish_button"] = "appuyez sur ~b~[E]~s~ pour pêcher.",
  ["fm_spawnboat_title"] = "faire apparaître un bateau",
  ["fm_spawnboat"] = "appuyez sur ~b~[E]~s~ pour sortir le bateau.",
  ["fm_boat_title"] = "bateau",
  ["fm_boat_return_title"] = "rendre le bateau",
  ["fm_boat_return_button"] = "appuyez sur ~b~[E]~s~ pour rendre le bateau.",
  ["fm_deliver_fish"] = "appuyez sur ~b~[E]~s~ pour livrer le poisson.",

  -- Fuel
  ["f_oil_refiner"] = "vestiaire du raffineur",
  ["f_drill_oil"] = "extraction le pétrole",
  ["f_fuel"] = "pétrole",
  ["f_drillbutton"] = "appuyez sur ~b~[E]~s~ pour forer.",
  ["f_fuel_refine"] = "pétrol raffiné",
  ["f_refine_fuel_button"] = "appuyez sur ~b~[E]~s~ pour raffiner le pétrole.",
  ["f_fuel_mixture"] = "mélange d'huiles raffinées",
  ["f_gas"] = "essence",
  ["f_fuel_mixture_button"] = "appuyez sur ~b~[E]~s~ pour mélanger.",
  ["f_deliver_gas"] = "livraison d'essence.",
  ["f_deliver_gas_button"] = "appuyez sur ~b~[E]~s~ pour livrer l'essence.",

  -- Miner
  ["m_miner_locker"] = "vestiaire du mineur",
  ["m_rock"] = "roche",
  ["m_pickrocks"] = "appuyez sur ~b~[E]~s~ pour récupérer de la roche.",
  ["m_washrock"] = "roche lavée",
  ["m_rock_button"] = "appuyez sur ~b~[E]~s~ pour laver les roches.",
  ["m_rock_smelting"] = "fonderie",
  ["m_copper"] = "cuivre",
  ["m_sell_copper"] = "revente de cuivre",
  ["m_deliver_copper"] = "appuyez sur ~b~[E]~s~ pour livrer le cuivre.",
  ["m_iron"] = "fer",
  ["m_sell_iron"] = "revente de fer",
  ["m_deliver_iron"] = "appuyez sur ~b~[E]~s~ pour livrer le fer.",
  ["m_gold"] = "or",
  ["m_sell_gold"] = "revente d'or",
  ["m_deliver_gold"] = "appuyez sur ~b~[E]~s~ pour livrer l'or.",
  ["m_diamond"] = "diamant",
  ["m_sell_diamond"] = "revente de diamants",
  ["m_deliver_diamond"] = "appuyez sur ~b~[E]~s~ pour livrer les diamants.",
  ["m_melt_button"] = "appuyez sur ~b~[E]~s~ pour fondre les roches.",

  -- Reporter
  ["reporter_name"] = "San Andreas Times",
  ["reporter_garage"] = "appuyez sur ~b~[E]~s~ pour descendre au garage.",

  -- Slaughterer
  ["s_slaughter_locker"] = "vestiaire de l'abatteur",
  ["s_hen"] = "poulailler",
  ["s_alive_chicken"] = "poulet vivant",
  ["s_catch_hen"] = "appuyez sur ~b~[E]~s~ pour attrapper des poulets vivants.",
  ["s_slaughtered_chicken"] = "poulet à emballer",
  ["s_chop_animal"] = "appuyez sur ~b~[E]~s~ pour dépecer les poulets.",
  ["s_slaughtered"] = "abattoir",
  ["s_package"] = "emballage",
  ["s_packagechicken"] = "poulet en barquette",
  ["s_unpackaged"] = "poulet à emballer",
  ["s_unpackaged_button"] = "appuyez sur ~b~[E]~s~ pour mettre le poulet en barquette.",
  ["s_deliver"] = "appuyez sur ~b~[E]~s~ pour livrer les barquettes de poulet.",

  -- Dress Designer
  ["dd_dress_locker"] = "vestiaire du couturier",
  ["dd_wool"] = "laine",
  ["dd_pickup"] = "appuyez sur ~b~[E]~s~ pour récupérer de la laine.",
  ["dd_fabric"] = "tissu",
  ["dd_makefabric"] = "appuyez sur ~b~[E]~s~ pour fabriquer du tissu.",
  ["dd_clothing"] = "vêtement",
  ["dd_makeclothing"] = "appuyez sur ~b~[E]~s~ pour récupérer des vêtements.",
  ["dd_deliver_clothes"] = "appuyez sur ~b~[E]~s~ pour livrer les vêtements.",
}
