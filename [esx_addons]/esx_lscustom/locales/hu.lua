...
-- Xenon Colors
  ...
  ['close'] = 'Close',
  ['mod_label'] = 'Mod',
  ['ui_customize'] = 'Testreszabás',
  ['ui_search'] = 'Opciók keresése',
  ['ui_no_results'] = 'Nincs megfelelő opció.',
  ['ui_selection'] = 'Kiválasztás',
  ['ui_in_cart'] = 'A kosárban',
  ['ui_add_to_cart'] = 'Kosárba',
  ['ui_list'] = 'Lista',
  ['ui_grid'] = 'Rács',
  ['ui_request_failed'] = 'A művelet sikertelen. Próbáld újra.',
  ['camera_default'] = 'View',
  ['camera_front'] = 'Front',
  ['camera_back'] = 'Rear',
