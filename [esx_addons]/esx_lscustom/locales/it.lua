...
-- Xenon Colors
  ...
  ['close'] = 'Close',
  ['mod_label'] = 'Mod',
  ['ui_customize'] = 'Personalizzazione',
  ['ui_search'] = 'Cerca opzioni',
  ['ui_no_results'] = 'Nessuna opzione corrispondente.',
  ['ui_selection'] = 'Selezione',
  ['ui_in_cart'] = 'Nel carrello',
  ['ui_add_to_cart'] = 'Aggiungi al carrello',
  ['ui_list'] = 'Elenco',
  ['ui_grid'] = 'Griglia',
  ['ui_request_failed'] = 'Operazione non riuscita. Riprova.',
  ['camera_default'] = 'View',
  ['camera_front'] = 'Front',
  ['camera_back'] = 'Rear',
